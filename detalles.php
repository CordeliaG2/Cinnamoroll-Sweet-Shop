                    ...
                    <div id="carouselimages" class="carousel slide">
                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="carousel-item active">
                                <img src="<?php echo $rutaImg; ?>" class="img-fluid">
                            </div>
...
<div class="d-grid gap-3 col-10 mx-auto">
    <button class="btn btn-primary" type="button" onclick="comprarAhora(<?php echo $id; ?>)">Comprar ahora</button>
    <button class="btn btn-outline-primary agregar-btn" 
        type="button" 
        data-id="<?php echo $id; ?>" 
        data-token="<?php echo hash_hmac('sha1', $id, KEY_TOKEN); ?>">
        Agregar al carrito
    </button>
</div>
...
document.addEventListener("DOMContentLoaded", function(){
    document.querySelectorAll('.agregar-btn').forEach(function(button) {
         button.addEventListener('click', function() {
             const id = this.getAttribute('data-id');
             const token = this.getAttribute('data-token');

             // Envía la petición al archivo agregar_carrito.php mediante fetch
             ...
             .then(data => {
                  if(data.ok){
                      ...
                      document.getElementById('contador-carrito').innerText = data.totalCount;
                  } else {
